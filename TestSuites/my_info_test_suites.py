...
mitc2 = unittest.TestLoader().loadTestsFromTestCase(ContactDetailsTestCase)
mitc3 = unittest.TestLoader().loadTestsFromTestCase(AddPhotoTestCase)
mitc4 = unittest.TestLoader().loadTestsFromTestCase(EmergencyContactsTestCase)

MyInfoTestSuite = unittest.TestSuite([mitc1, mitc2, mitc3, mitc4])

unittest.TextTestRunner(verbosity=2).run(MyInfoTestSuite)